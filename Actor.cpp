...
unsigned int Actor::getCategory() const
{
	...
	case Type::Turtle3:
		...
		break;
	case Type::Tree1:
		return Category::Tree1;
		break;
	case Type::Tree2:
		return Category::Tree2;
		break;
	case Type::LilyPad:
		return Category::Lilipad;
		break;
	}
}
...
{
	if (this->getCategory() != Category::Frog) {
		// leave velocity as is 
	}
	else {
		// movement pattern
